...
| **Take Action** ✍️<br> After you create a record, you will get a DM from the app's bot user with links to open the record directly in Airtable or edit/delete the record directly from Slack. | [![](docs/confirmation_message_with_actions.png)](docs/confirmation_message_with_actions.png) |
